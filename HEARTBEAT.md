...
## 🤝 每20分钟主动汇报机制（2026-04-20 新增）

> 来源：李伟要求——不能闲着，待机不行
> 替代：旧的静默窗口机制 → 每20分钟强制主动汇报

**触发：** LaunchAgent `com.nova.status-report` 每 20 分钟自动运行  
**内容：** 当前在做什么 + 下一步打算 + 今日进展摘要  
**发送方式：** 飞书私信（`user:ou_8b42447ee49c0f3a8c4c6df96e7ec4ae`）  
**状态：** ✅ 已就位（2026-04-20 14:39 验证通过）
